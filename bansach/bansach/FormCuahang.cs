...
namespace bansach
{
    public partial class FormCuahang : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'bansachDataSet20.sach3' table. You can move, or remove it, as needed.
            this.sach3TableAdapter2.Fill(this.bansachDataSet20.sach3);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                sach3BindingSource2.RemoveCurrent();
            }
        }

        private void button6_Click(object sender, EventArgs e)
        {
            int i = sach3TableAdapter2.Update(bansachDataSet20.sach3);
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            connection.Open();
            adapter = new SqlDataAdapter("select * from sach3 where tensach like '"+textBox1.Text+"%'", connection);
            table = new DataTable();
            adapter.Fill(table);
